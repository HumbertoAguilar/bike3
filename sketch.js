...
function draw() {
  ...
  text("Presiona la tecla de flecha hacia arriba para reiniciar el juego",400,250)
...
function pinkCyclists(){
        player1 =createSprite(1100,Math.round(random(50, 350)));
        player1.scale =0.06;
...
function yellowCyclists(){
        player2 =createSprite(1100,Math.round(random(50, 350)));
        player2.scale =0.06;
...
function redCyclists(){
        player3 =createSprite(1100,Math.round(random(50, 350)));
        player3.scale =0.06;
